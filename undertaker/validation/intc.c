...
I: creating intc.c.B0.missing.locally.dead
I: creating intc.c.B1.missing.locally.undead
I: creating intc.c.B2.missing.locally.dead
I: creating intc.c.B3.missing.locally.dead
 * check-output-end
 */
